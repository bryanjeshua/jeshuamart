"""
Django settings for jeshuamart project.
...
SECRET_KEY = 'django-insecure-ghc2^wd+rhxk9b+=d@ckz7b7%u0^rih4dzxzwj8tvr1e#*v+18'
...
WSGI_APPLICATION = 'jeshuamart.wsgi.application'
